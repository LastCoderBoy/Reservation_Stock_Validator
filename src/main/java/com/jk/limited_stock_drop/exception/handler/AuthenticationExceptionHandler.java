package com.jk.limited_stock_drop.exception.handler;

import com.jk.limited_stock_drop.dto.ApiResponse;
import com.jk.limited_stock_drop.exception.*;
...
public class AuthenticationExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException ex) {
        log.warn("[EXCEPTION] Business rule violated: {}", ex.getMessage());
        return ResponseEntity
    ...
    public ResponseEntity<ApiResponse<Void>> handleDisabledException(DisabledException ex) {
        log.error("[AUTH-EXCEPTION-HANDLER] User account is not active: {}", ex.getMessage());

        return ResponseEntity
                .status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponse.error("Account is not active. Please contact the administration."));
    }
    ...
    // Exception handler for Role Based Access Control (RBAC)
    @ExceptionHandler(AuthorizationDeniedException.class)
    public ResponseEntity<ApiResponse<Void>> handleAuthorizationDeniedException(AuthorizationDeniedException ex) {
        log.error("[AUTH-EXCEPTION-HANDLER] Authorization denied: {}", ex.getMessage());
